...
import { setSelectedBrand, fetchModelById, setSelectedModel, setSelectedProp, setSelectedType } from '../redux/reducers/BusReducer';
...
const BusIdentification = () => {
  ...
  const { selectedBrand, selectedModel, selectedType, brandList, propList, typeList, modelList, selectedProp } = useAppSelector((state: any) => state.bus)
            ...
            <div className="col-12 col-md-3">
              <div>
                <Form>
                  ...
                  <div className="form-group">
                    <FormItem errors={errors.number_of_seats} isValid={isValid} touched={touched.number_of_seats} formik={formik.errors.number_of_seats} type="number_of_seats" values={values.number_of_seats} handleChange={handleChange} text="Koltuk Sayısı" />
                  </div>
                  <div className="form-group">
                    <FormControl fullWidth>
